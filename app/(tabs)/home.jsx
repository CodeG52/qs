...
import { ScrollView, Image, FlatList, Text, View } from "react-native";
...
const Home = () => {
      ...
      data: [
        {
          ...
          subtitle: 'Unlock the power within with I AM Meditation, a transformative journey into quantum jumping.',
          Author: 'Craig Khan',
  ...
  const renderItem = ({ item }) => (
    <View>
      <Text className="text-lg font-pregular mb-3 mt-4 text-[#FFD700]">{item.title}</Text>
    ...
    <SafeAreaView className="bg-primary flex-1">
      <View className="bg-primary flex-1 my-6 px-4 space-y-6">
        <View className="flex justify-between items-start flex-row mb-6">
          <View>
            <Text className="font-pmedium text-sm text-gray-100 text-[#FFD700]">Welcome Back</Text>
